...
contract MintyPreset is ERC721PresetMinterPauserAutoId, ERC721URIStorage {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 firstTokenId, uint256 batchSize) internal virtual override(ERC721, ERC721PresetMinterPauserAutoId) {
